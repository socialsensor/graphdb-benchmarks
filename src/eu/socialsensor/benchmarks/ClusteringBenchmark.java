  ...
  private void titanClusteringBenchmark(String dbPAth) throws ExecutionException, IOException {
    ...
    for (int i = 0; i < cacheSizes.size(); i++) {
      ...
      for (int j = 0; j < numberOfLoops; j++) {
        ...
        Map<Integer, List<Integer>> actualCommunities = utils.mapNodesToCommunities("/temp/datasets/weighted_networks/network.dat");
        Metrics metrics = new Metrics();
        double NMI = metrics.normalizedMutualInformation(500, actualCommunities, predictedCommunities);
